...
// tests for SteamGameSearchWithDetails
void main() {
  final instance = SteamGameSearchWithDetailsBuilder();
  // TODO add properties to the builder and call build()

  group(SteamGameSearchWithDetails, () {
    ...
    // String headerImage
    test('to test the property `headerImage`', () async {
      // TODO
    });

    // URL to the capsule image of the game.
    // String capsuleImage
    test('to test the property `capsuleImage`', () async {
      // TODO
    });
    ...
    // int requiredAge
    test('to test the property `requiredAge`', () async {
      // TODO
    });
