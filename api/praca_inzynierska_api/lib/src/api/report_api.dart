...
class ReportApi {
  ...
  Future<Response<Report>> createReport({
    ...
    try {
      const _type = FullType(Report);
      _bodyData = _serializers.serialize(report, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteReport({
    ...
    final _path = r'/reports/{reportId}'.replaceAll(
        '{' r'reportId' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Report>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Report>>> getReports({
    int? page = 0,
    int? size = 10,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    BuiltList<Report>? _responseData;
    ...
    return Response<BuiltList<Report>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
