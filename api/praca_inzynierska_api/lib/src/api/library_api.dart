...
class LibraryApi {
  ...
  /// Add a game to the current user&#39;s library with a status
  ///
  ///
  /// Parameters:
  /// * [createLibraryItem] - Details for adding a game to library
  ...
  Future<Response<LibraryItem>> addLibraryItem({
    required CreateLibraryItem createLibraryItem,
    ...
    try {
      const _type = FullType(CreateLibraryItem);
      _bodyData =
          _serializers.serialize(createLibraryItem, specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [createLibrary] - Library creation request
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ModelLibrary>> createLibrary({
    ...
    try {
      const _type = FullType(CreateLibrary);
      _bodyData = _serializers.serialize(createLibrary, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Retrieve the library for the current user
  ///
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Returns a [Future] containing a [Response] with a [ModelLibrary] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ModelLibrary>> getLibrary({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Update the status of a game in the current user&#39;s library
  ///
  ///
  /// Parameters:
  ...
  Future<Response<LibraryItem>> updateLibraryItemStatus({
    ...
    try {
      const _type = FullType(UpdateLibraryItem);
      _bodyData =
          _serializers.serialize(updateLibraryItem, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
