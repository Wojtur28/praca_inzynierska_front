...
class RecommendedGamesApi {
  ...
  const RecommendedGamesApi(this._dio, this._serializers);

  /// Retrieve recommended games based on viewed game tags
  ///
  ///
  /// Parameters:
  ...
  Future<Response<BuiltList<SteamGame>>> getRecommendedGames({
    ...
    final _path = r'/games/recommended';
