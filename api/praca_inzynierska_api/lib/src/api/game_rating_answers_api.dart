...
class GameRatingAnswersApi {
  ...
  /// Update an answer for a specific game rating
  ///
  ///
  /// Parameters:
  /// * [ratingId] - ID of the rating to update an answer for.
  /// * [answerId] - ID of the answer to update.
  /// * [gameRatingAnswer] - Answer details
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [GameRatingAnswer] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GameRatingAnswer>> updateGameRatingAnswer({
    required String ratingId,
    required String answerId,
    required GameRatingAnswer gameRatingAnswer,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GameRatingAnswer);
      _bodyData =
          _serializers.serialize(gameRatingAnswer, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
